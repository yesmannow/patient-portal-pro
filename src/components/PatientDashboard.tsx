...
import { CalendarBlank, ChatCircle, Plus, Clock, CheckCircle, CreditCard } from '@phosphor-icons/react';
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="appointments" className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-1">View and schedule your appointments</p>
            </div>
            <Button onClick={() => setBookingDialogOpen(true)} className="bg-accent hover:bg-accent/90" disabled={!currentPatient}>
              <Plus className="w-5 h-5 mr-2" />
            ...
            {myAppointments.length === 0 ? (
              <Card>
                <CardContent className="py-16">
                  <div className="text-center">
                    <CalendarBlank className="w-16 h-16 text-muted-foreground mx-auto mb-4" weight="duotone" />
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <Badge className={
                            ...
                            appointment.status === 'cancelled' ? 'bg-gray-500 text-white' :
        ...
        <TabsContent value="payments" className="space-y-0">
          {currentPatient ? (
            <PaymentHistory patientId={currentPatient.id} />
          ) : (
            <Card>
              <CardContent className="py-16">
                <div className="text-center">
                  <CreditCard className="w-16 h-16 text-muted-foreground mx-auto mb-4" weight="duotone" />
